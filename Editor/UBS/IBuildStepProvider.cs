...
namespace UBS
{
	...
	/// The configuration (<see cref="BuildConfiguration"/>) parameter contains all the information of the build currently happening. 
	/// You can access parameters set in the specific step instance through the configuration parameter. 
	/// 
	...
	public interface IBuildStepProvider
	{
		...
		void BuildStepStart(BuildConfiguration configuration);
		/// <summary>
